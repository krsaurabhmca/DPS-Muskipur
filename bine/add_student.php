    ...
    if ($id != '') {
    	...
    	if ($res['count'] > 0 and $res['status'] == 'success') {
    		...
    		if ($student_admission == '') {
    			// $student_admission = 'GHS'. str_pad($student['id'], 5, 0, STR_PAD_LEFT).$adm_suffix;
    			$student_admission = 1000 + $student['id'];
    		}
    	}
    }
}
...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<form id='update_frm' action='update_student'>
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group row">
								<div class="col-sm-6">
								    ...
								    <input type='text' name='<?= $row['col_name'] ?>' value='<?php echo $res['data'][$row['col_name']] ?>'>
								</div>
							</div>
						</div>
                        <?php } ?>
