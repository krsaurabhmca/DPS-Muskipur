...
?>
	...
	foreach($arr as $copy){ ?>
			...
			<table border='1' class='rcpt' align='center' rules='all' cellpadding='5px' width='360px'>
				<thead>
					<tr>
						<td colspan='5' align='center' class='head'>
							<img align='left' src='images/dps_logo.png' height='70px'>
							<span style='font-size:18px;font-weight:600;'> <?php echo $full_name; ?> </span><br>
							(Based on CBSE Pattern) <br>
							<!--<b>Affiliation No. : <?php //echo $aff_no; ?> School Code : <?php// echo $school_code; ?></b><br>-->
							<?php echo $inst_address1; ?>, <?php echo $inst_address2; ?> <br>
							Contact No.: <?php echo $inst_contact; ?> , Email : <?php echo $inst_email; ?> <br>  Website : <?php echo $inst_url; ?>
						</td>
					</tr>
					<tr bgcolor='#f5f5f5'>
					    <?php if ($receipt['status']=='CANCEL'){ ?>
						<td colspan='3' style='color:red;text-decoration: line-through;'> Receipt No. : <b><?php echo $rid; ?> </b></td>
						<?php }else{ ?>
						<td colspan='3'> Receipt No. : <b><?php echo $rid; ?> </b></td>
						<?php } ?>
						
						<!--<td align='right' colspan='2'><?php echo date('d-M-Y h:i:s', strtotime($receipt['created_at'])); ?></td>-->
						<td align='right' colspan='2'><?php echo date('d-M-Y', strtotime($receipt['paid_date'])); ?></td>
					</tr>
					<tr>
						<td colspan='5' style='text-align:center'>
							<b> <?=  $copy ?> Copy : Fee Details of <?php echo add_space(str_replace(',', ', ', $receipt['paid_month'])); ?></b>
						</td>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td> Adm. No. <?php echo strtoupper($student['student_admission']); ?></td>
					...
					<tr>
						<td colspan='5' height='140px' valign='top'>
							<table width='100%' border='0' rules='none'>
								...
								<?php } ?>
								<?php if ($receipt['late_fine'] != 0) { ?>
									<tr>
										<td> Late Fine </td>
										<td align='right'><?php echo $receipt['late_fine']; ?></td>
									</tr>
								<?php } ?>
							</table>
						</td>
					...
					<?php if ($receipt['remarks'] != '') { ?>
						...
						<tr>
							...
							<td align='right'><b><?php echo $receipt['current_dues']; ?></b></td>
						</tr>
...
<?php } } ?>
	            ...
	            <center style='float:left'>
					<a href='collect_fee' class='btn'> New Payment </a>
