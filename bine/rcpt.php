...
?>
	...
	<table>
		<td>
			<table border='1' align='center' rules='all' cellpadding='5px' width='360px'>
				<thead>
					<tr>
						<td colspan='5' align='center' class='head'>
							<img align='left' src='images/logo.png' height='70px'>
					...
					<tr>
						<td colspan='5' style='text-align:center'>
							<b> Office Copy : Fee Details of <?php echo add_space(str_replace(',', ', ', $receipt['paid_month'])); ?></b>
						</td>
					</tr>
				</thead>
				<tbody>
