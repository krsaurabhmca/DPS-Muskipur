  ...
  return (
    <SafeAreaProvider>
      ...
      >
        ...
        <Stack.Screen name="MarksEntry" options={{ headerShown: false }} />
        <Stack.Screen name="SelfieAttendance" options={{ headerShown: false }} />
        <Stack.Screen name="TeacherAttendanceScreen" options={{ headerShown: false }} />
